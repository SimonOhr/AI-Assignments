...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);
    ...
    //}
    public void runExperiment(NNPacman pacManController, Controller<EnumMap<GHOST, MOVE>> ghostController, int trials)
    {
        double avgScore = 0;
        ...
        pacManController.resetBreedLog();
        ...
        for (int i = 0; i < trials; i++)
        {
            ...
            pacManController.setFitnessAfterGame(game.getScore());

            avgScore += game.getScore();
            System.out.println("Latest run: " + i + "\t Fitness: " + game.getScore());

            pacManController = new NNPacman();
        }

        pacManController.resetGenerationTracker();
